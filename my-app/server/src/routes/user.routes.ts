...
// ============================================================
// SiliconFlow API Key 管理路由（需认证，按用户隔离）
// ============================================================

// 获取密钥状态（脱敏）
userRouter.get("/siliconflow-key", authMiddleware, userController.getSiliconFlowKey);

// 保存密钥（加密存储）
userRouter.put("/siliconflow-key", authMiddleware, userController.saveSiliconFlowKey);

// 删除密钥
userRouter.delete("/siliconflow-key", authMiddleware, userController.deleteSiliconFlowKey);

// 测试连通性（不落库）
userRouter.post("/siliconflow-key/test", authMiddleware, userController.testSiliconFlowKey);
